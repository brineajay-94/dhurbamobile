...
var autoSaveProductId = null, autoSaveProductTimer = null;
var autoSaveBannerId = null, autoSaveBannerTimer = null;
var autoSaveSliderId = null, autoSaveSliderTimer = null;
var autoSaveBrandId = null, autoSaveBrandTimer = null;
var autoSavePromotionId = null, autoSavePromotionTimer = null;
var autoSaveSubBannerId = null, autoSaveSubBannerTimer = null;
var autoSaveUserId = null, autoSaveUserTimer = null;
var autoSaveRepairId = null, autoSaveRepairTimer = null;
  ...
  autoSaveConfig.forEach(function (cfg) {
    ...
    formEl.addEventListener('input', function () {
      ...
      if (id) {
        ...
        window[cfg.saveFn](cfg.sheet, null, data).then(function (res) {
          if (res && res.id) {
            idEl.value = res.id;
            window[idVar] = res.id;
          }
...
function cancelBannerModal() { if (autoSaveBannerId) { fb_delete('banners', autoSaveBannerId); autoSaveBannerId = null; } closeModal('bannerModal'); }
...
function cancelSliderModal() { if (autoSaveSliderId) { fb_delete('sliders', autoSaveSliderId); autoSaveSliderId = null; } closeModal('sliderModal'); }
...
function cancelPromotionModal() { if (autoSavePromotionId) { fb_delete('promotions', autoSavePromotionId); autoSavePromotionId = null; } closeModal('promotionModal'); }
...
function cancelBrandModal() { if (autoSaveBrandId) { fb_delete('brands', autoSaveBrandId); autoSaveBrandId = null; } closeModal('brandModal'); }
...
function cancelSubBannerModal() { if (autoSaveSubBannerId) { fb_delete('subBanners', autoSaveSubBannerId); autoSaveSubBannerId = null; } closeModal('subBannerModal'); }
...
function cancelProductModal() { if (autoSaveProductId) { sheets_delete('products', autoSaveProductId); autoSaveProductId = null; } closeModal('productModal'); }
...
function cancelRepairModal() { if (autoSaveRepairId) { sheets_delete('repairs', autoSaveRepairId); autoSaveRepairId = null; } closeModal('repairModal'); }
...
function cancelUserModal() { if (autoSaveUserId) { sheets_delete('users', autoSaveUserId); autoSaveUserId = null; } closeModal('userModal'); }
